...
const fieldId = '#cause_name'
const editId = '#cause-name-edit'
const submitId = '#cause-name-submit'
const cancelId = '#cause-name-cancel'
const successBadgeId = '#cause-name-saved'
const errorDivId = '#cause-name-error'
