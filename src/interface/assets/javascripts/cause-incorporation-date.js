...
const fieldId = '#cause_incorporation_date'
const editId = '#cause-incorporation-date-edit'
const submitId = '#cause-incorporation-date-submit'
const cancelId = '#cause-incorporation-date-cancel'
const successBadgeId = '#cause-incorporation-date-saved'
const errorDivId = '#cause-incorporation-date-error'
