...
const fieldId = '#cause_email'
const editId = '#cause-email-edit'
const submitId = '#cause-email-submit'
const cancelId = '#cause-email-cancel'
const successBadgeId = '#cause-email-saved'
const errorDivId = '#cause-email-error'
