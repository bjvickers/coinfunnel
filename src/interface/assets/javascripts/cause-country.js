...
const fieldId = '#cause_country'
const editId = '#cause-country-edit'
const submitId = '#cause-country-submit'
const cancelId = '#cause-country-cancel'
const successBadgeId = '#cause-country-saved'
const errorDivId = '#cause-country-error'
